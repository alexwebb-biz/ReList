...
export const NotificationBell: React.FC = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {/* Dropdown */}
      {isOpen && (
        <div className="fixed sm:absolute inset-x-0 sm:inset-x-auto bottom-0 sm:bottom-auto sm:right-0 sm:mt-2 w-full sm:w-80 bg-white rounded-t-xl sm:rounded-xl shadow-xl border border-slate-200 overflow-hidden z-50">
          {/* Header */}
          ...
          {/* Footer */}
          {notifications.length > 0 && (
            <div className="px-4 py-3 sm:py-2 border-t border-slate-200 bg-slate-50">
              <button
                onClick={() => {
                  setIsOpen(false);
